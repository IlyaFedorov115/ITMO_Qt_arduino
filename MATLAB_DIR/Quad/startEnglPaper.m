...
g = 9.81; 
m = 0.486+4*0.05*0;                  % масса квадрокоптера
...
I_xPID = 4.856 * 10^(-3);   % Константы, которые используются в 
I_yPID = 4.856 * 10^(-3);   % ПИД (старые, имитация изменения массы без коэффициентов
I_zPID = 8.801 * 10^(-3); 

%I_x = 0.5*0.486*0.1^2 + 2*0.05*0.225^2;
%I_y = 0.5*0.486*0.1^2 + 2*0.05*0.225^2;
%I_z = 0.5*0.486*0.1^2+4*0.05*0.225^2;
