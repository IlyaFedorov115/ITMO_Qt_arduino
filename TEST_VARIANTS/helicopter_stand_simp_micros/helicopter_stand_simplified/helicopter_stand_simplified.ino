...
/*
          ========================== ВЕРСИЯ С ДОБАВЛЕНИЕМ ОТСЧЕТА ВРЕМЕНИ ПО MICROS ================================
*/
...
void loop() {
  ...
  timersController.updateElapsed();
  elapsedTime = timersController.elapsedTimeMicros / 1000000.0;

 // timersController.calcElapsedSecFromMicro();

/*
  Serial.println();
  Serial.print("mil_el: "); Serial.print(timersController.elapsedTimeMsecs); 
  Serial.print("mic_el: "); Serial.print(timersController.elapsedTimeMicros);
  Serial.print("el: "); Serial.print(timersController.elapsedTimeSecs*1000.0);
  Serial.println();
*/
