...
const double throttle = 1605;// 1470 1550; -long     //initial value of throttle
const float desired_angle = 10; // target angle  better use 5-6 whant

const double pid_Kp = 0.32;//0.72;//3.55
const double pid_Ki = 0.17;//0.04;//0.003
const double pid_Kd = 0.065;//0.02;//2.05
...
const float PWM_SEND_MAX = 1645;//1580.0;   // подаваемые на двигатель
