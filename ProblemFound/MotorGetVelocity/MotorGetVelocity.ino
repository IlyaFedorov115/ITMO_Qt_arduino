...
float kp = 2.25000; //2.65 0.8 1.15 - неплохи
float ki = 1.45000; 
float kd = 1.150;
...
//if (count <= 0){  
  ...
  /* error | filt_err | angleVel | angleAccel | D | pwm | dt */
  ///*
  
  Serial.print(error); Serial.print(','); 
  Serial.print(errorFilt); Serial.print(',');
  Serial.print(angleVelocity); Serial.print(',');
  Serial.print(angleAccel); Serial.print(','); Serial.print(errorDiff * kd); Serial.print(',');
...
void calculateAngles() {
  ...
  angleAccel = ay / 16384.0;/// 32768.0 * 2;
  angleVelocity = gy / 131.0;
...
inline void getAngle()
{
  ...
  angleAccel = Acc_rawY / 16384.0;/// 32768.0 * 2;
  angleVelocity = Gyro_rawYf / 131.0;
